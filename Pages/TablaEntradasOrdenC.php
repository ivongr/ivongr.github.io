...
<body>
    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                <a href="RegistrarEntradasOrdenC.php?idProductosRequisicion=<?php echo $idProductosRequisicion; ?>" style="background-color: #62BA62;" class="btn text-white me-md-2">
    ...
    <div class="row">
        <div class="col-12 text-center">
            <a href="ResultadosOrdenCompra.php" class="btn btn-dark">
                Volver
            </a>
        </div>
    </div>
